                    ...
                    <div key={idx}>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {sub.items.map((item, i) => (
                          <div key={i} className={`p-5 rounded-xl ${theme.surface} border ${theme.border} ${theme.surfaceHover} transition-colors cursor-pointer group flex justify-between items-center`}>
